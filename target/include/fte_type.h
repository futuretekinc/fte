...
#define FTE_RET_SOCKET_CLOSED           (MQX_ERROR_BASE|0x92)

#define FTE_RET_MODBUS_ERROR            (MQX_ERROR_BASE|0xA0)
#define FTE_RET_MODBUS_INVALID_FUNCTION (MQX_ERROR_BASE|0xA1)
#define FTE_RET_MODBUS_INVALID_ADDRESS  (MQX_ERROR_BASE|0xA2)
#define FTE_RET_MODBUS_INVALID_DATA     (MQX_ERROR_BASE|0xA3)
#define FTE_RET_MODBUS_EXECUTE_ERROR    (MQX_ERROR_BASE|0xA4)
