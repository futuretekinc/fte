...
FTE_RET     FTE_VALUE_initPH(FTE_VALUE_PTR pValue, FTE_UINT32 ulValue);
...
FTE_RET     FTE_VALUE_getPH(FTE_VALUE_PTR pObj, FTE_UINT32_PTR pulValue);
FTE_RET     FTE_VALUE_setPH(FTE_VALUE_PTR pObj, FTE_UINT32 ulValue);

FTE_RET     FTE_VALUE_getMM(FTE_VALUE_PTR pObj, FTE_UINT32_PTR pulValue);
FTE_RET     FTE_VALUE_setMM(FTE_VALUE_PTR pObj, FTE_UINT32 ulValue);
