...
#define FTE_DEV_LWGPIO_SYS_LED_0        (FTE_DEV_TYPE_LWGPIO | 0x09)
...
#else
#define FTE_DEV_LWGPIO_SYS_LED_1        (FTE_DEV_TYPE_LWGPIO | 0x0F)
#endif
...
#define FTE_DEV_GPIO_SYS_LED_0          (FTE_DEV_TYPE_GPIO | 0x09)
...
#else
#define FTE_DEV_GPIO_SYS_LED_1          (FTE_DEV_TYPE_GPIO | 0x10)
#endif
...
#define FTE_GPIO_SYS_LED_0              (GPIO_PORT_C | GPIO_PIN12)
#if  FTE_LCD_SUPPORTED
#define FTE_GPIO_LCD_POWER              (GPIO_PORT_B | GPIO_PIN5)
#else
#define FTE_GPIO_SYS_LED_1              (GPIO_PORT_B | GPIO_PIN5)
#endif
...
#define FTE_GPIO_SYS_LED_0_MUX          (LWGPIO_MUX_C12_GPIO)
#if  FTE_LCD_SUPPORTED
#define FTE_GPIO_LCD_POWER_MUX          (LWGPIO_MUX_B5_GPIO)
#else
#define FTE_GPIO_SYS_LED_1_MUX          (LWGPIO_MUX_B5_GPIO)
#endif
