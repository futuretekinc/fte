...
typedef struct {
	...
	uint8_t mac_options;			/*!<Bit mask for: MAC_ASSOCPERMIT=0x01, MAC_ASSOC_CORD=0x02,MAC_BATT_LIFE_EXT=0x04, MAC_RX_ON_WHEN_IDLE=0x08, MAC_PROMISCOUS_MODE=0x10,MAC_GTS_PERMIT=0x20,
MAC_SUPPORT_SHORT_ADDR=0x40  */
...
extern char get_coord_address(sockaddr_t *address);
...
extern char mac_pending_req(buffer_t *buf);
