...
cp -f "${MQXROOTDIR}/config/fts_base/user_config.h" "${OUTPUTDIR}/../user_config.h"
cp -f "${MQXROOTDIR}/mqx/source/bsp/fts_base/bsp.h" "${OUTPUTDIR}/bsp.h"
cp -f "${MQXROOTDIR}/mqx/source/bsp/fts_base/bsp_cm.h" "${OUTPUTDIR}/bsp_cm.h"
cp -f "${MQXROOTDIR}/mqx/source/bsp/fts_base/bsp_rev.h" "${OUTPUTDIR}/bsp_rev.h"
cp -f "${MQXROOTDIR}/mqx/source/bsp/fts_base/fts_base.h" "${OUTPUTDIR}/fts_base.h"
cp -f "${MQXROOTDIR}/mqx/source/bsp/fts_base/init_lpm.h" "${OUTPUTDIR}/init_lpm.h"
cp -f "${MQXROOTDIR}/mqx/source/bsp/fts_base/PE_LDD.h" "${OUTPUTDIR}/Generated_Code/PE_LDD.h"
cp -f "${MQXROOTDIR}/mqx/source/bsp/fts_base/TSS_SystemSetup.h" "${OUTPUTDIR}/TSS_SystemSetup.h"
...
cp -f "${MQXROOTDIR}/mqx/source/io/dma/dma.h" "${OUTPUTDIR}/dma.h"
cp -f "${MQXROOTDIR}/mqx/source/io/dma/edma.h" "${OUTPUTDIR}/edma.h"
...
cp -f "${MQXROOTDIR}/mqx/source/io/hwtimer/hwtimer_systick.h" "${OUTPUTDIR}/hwtimer_systick.h"
...
cp -f "${MQXROOTDIR}/mqx/source/io/spi/spi_dspi_common.h" "${OUTPUTDIR}/spi_dspi_common.h"
cp -f "${MQXROOTDIR}/mqx/source/io/spi/spi_dspi_dma.h" "${OUTPUTDIR}/spi_dspi_dma.h"
...
cp -f "${MQXROOTDIR}/mqx/source/bsp/fts_base/cw/dbg/fts_base.mem" "${OUTPUTDIR}/../../dbg/fts_base.mem"
cp -f "${MQXROOTDIR}/mqx/source/bsp/fts_base/cw/dbg/init_kinetis.tcl" "${OUTPUTDIR}/../../dbg/init_kinetis.tcl"
cp -f "${MQXROOTDIR}/mqx/source/bsp/fts_base/cw/dbg/mass_erase_kinetis.tcl" "${OUTPUTDIR}/../../dbg/mass_erase_kinetis.tcl"
cp -f "${MQXROOTDIR}/mqx/source/bsp/fts_base/cw/extmram.lcf" "${OUTPUTDIR}/extmram.lcf"
cp -f "${MQXROOTDIR}/mqx/source/bsp/fts_base/cw/intflash.lcf" "${OUTPUTDIR}/intflash.lcf"
cp -f "${MQXROOTDIR}/mqx/source/bsp/fts_base/cw/intram.lcf" "${OUTPUTDIR}/intram.lcf"
cp -f "${MQXROOTDIR}/mqx/source/io/hmi/TSS/lib_cw/TSS_KXX_M4.a" "${OUTPUTDIR}/tss.a"
fi
# iar files
if [ "${TOOL}" = "iar" ]; then
cp -f "${MQXROOTDIR}/mqx/source/bsp/fts_base/iar/intflash.icf" "${OUTPUTDIR}/intflash.icf"
cp -f "${MQXROOTDIR}/mqx/source/bsp/fts_base/iar/ram.icf" "${OUTPUTDIR}/ram.icf"
cp -f "${MQXROOTDIR}/mqx/source/io/hmi/TSS/lib_iar/TSS_KXX_M4.a" "${OUTPUTDIR}/tss.a"
fi
# cw10gcc files
if [ "${TOOL}" = "cw10gcc" ]; then
cp -f "${MQXROOTDIR}/mqx/source/bsp/fts_base/gcc_cw/intflash.ld" "${OUTPUTDIR}/intflash.ld"
fi
# uv4 files
if [ "${TOOL}" = "uv4" ]; then
cp -f "${MQXROOTDIR}/mqx/source/bsp/fts_base/uv4/intflash.scf" "${OUTPUTDIR}/intflash.scf"
