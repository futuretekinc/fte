...
#if FTE_BL_CFG_TFTP_CMD|| FTE_BL_CFG_TFTPUP_CMD || FTE_BL_CFG_TFTPS_CMD || FTE_BL_CFG_ERASE_CMD || FTE_BL_CFG_MEM_CMD
...
{
#if FNET_CFG_FLASH 
    {"FLASH", FTE_BL_FLASH_ADDRESS, FTE_BL_FLASH_SIZE, fnet_flash_memcpy, fnet_flash_erase, FNET_CFG_CPU_FLASH_PAGE_SIZE},
#endif
...
{
    {"Boot Loader",     FTE_BL_LOADER_ADDRESS,          FTE_BL_LOADER_SIZE},
    {"Static Params",   FTE_BL_STATIC_PARAMS_ADDRESS,   FTE_BL_STATIC_PARAMS_SIZE},
    {"Dynamic Params",  FTE_BL_DYNAMIC_PARAMS_ADDRESS,  FTE_BL_DYNAMIC_PARAMS_SIZE},
    {"App Data",        FTE_BL_APP_DATA_ADDRESS,        FTE_BL_APP_DATA_SIZE},
    {0,0,0} /* End */
};
...
#endif /* FTE_BL_CFG_TFTP_CMD || FTE_BL_CFG_TFTPUP_CMD || FTE_BL_CFG_TFTPS_CMD || FTE_BL_CFG_ERASE_CMD || FTE_BL_CFG_MEM_CMD*/
