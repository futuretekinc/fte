...
#ifndef _FTE_BL_PARAMS_H_

#define _FTE_BL_PARAMS_H_
 ...
 ******************************************************************************/
#define FTE_BL_PARAMS_SIGNATURE             "FTE SERIES"

/**************************************************************************/ /*!
 * @brief The maximum length of the device id.
 ******************************************************************************/
#define FTE_BL_PARAMS_DEVICE_ID_SIZE        (32)

/**************************************************************************/ /*!
 * @brief The maximum length of the model .
 ******************************************************************************/
#define FTE_BL_PARAMS_MODEL_SIZE            (16)

/**************************************************************************/ /*!
 * @brief The maximum length of the signature.
 ******************************************************************************/
#define FTE_BL_PARAMS_SIGNATURE_SIZE        (16)

/**************************************************************************/ /*!
 * @brief The maximum length of the boot-script.
 ******************************************************************************/
#define FTE_BL_PARAMS_BOOT_SCRIPT_SIZE       (256)

/**************************************************************************/ /*!
 * @brief The maximum length of the @c file_name field of the 
 * @ref fapp_params_tftp structure.
 ******************************************************************************/
#define FTE_BL_PARAMS_TFTP_FILE_NAME_SIZE    (40)
...
/**************************************************************************/ /*!
 * @brief Application parameter structure used to save the device
 * specific configuration to a persistent storage.
 ******************************************************************************/
typedef struct  FTE_BL_DEVICE_PARAMS_STRUCT
{
    struct
    {
    ...
    char            id[FTE_BL_PARAMS_DEVICE_ID_SIZE + 1];   /**< @brief Device ID 
                            */    
    char            model[FTE_BL_PARAMS_MODEL_SIZE + 1];    /**< @brief Device Model
                            */    
    unsigned char   mac[6];  /**< @brief Ethernet MAC address. 
                           */
}   FTE_BL_DEVICE_PARAMS;

/**************************************************************************/ /*!
 * @brief Application parameters structure used to save the FNET Stack 
 * specific configuration to a persistent storage.
 ******************************************************************************/
typedef struct FTE_BL_NET_PARAMS_STRUCT
{
 ...
 * specific configuration to a persistent storage.
 ******************************************************************************/
typedef struct FTE_BL_BOOT_PARAMS_STRUCT
{
    ...
    unsigned long go_address; /**< @brief Default entry point address
                             ...
                             */                                      
    char script[FTE_BL_PARAMS_BOOT_SCRIPT_SIZE]; /**< @brief Command script string. @n
 ...
 * specific configuration to a persistent storage.
 ******************************************************************************/
typedef struct FTE_BL_TFTP_PARAMS_STRUCT
{
    unsigned long server;           /**< @brief This is the default TFTP server 
    ...
    unsigned long file_raw_address; /**< @brief Load address for raw-binary file 
                                     ...
                                     */                
    char file_name[FTE_BL_PARAMS_TFTP_FILE_NAME_SIZE]; /**< @brief This is the default file name
 ...
 ******************************************************************************/
typedef struct FTE_BL_STATIC_PARAMS_STRUCT
{
    char signature[FTE_BL_PARAMS_SIGNATURE_SIZE]; /**< @brief Signature string.@n
                                             * It's used for simple check if configuration 
                                             * structure is present in a persistent storage. 
                                             */
    unsigned long           index;
    
    FTE_BL_DEVICE_PARAMS    device;
    
    unsigned long           ulCRC32;
    
} FTE_BL_STATIC_PARAMS;

typedef struct FTE_BL_DYNAMIC_PARAMS_STRUCT
{
    char signature[FTE_BL_PARAMS_SIGNATURE_SIZE]; /**< @brief Signature string.@n
                                             * It's used for simple check if configuration 
                                             * structure is present in a persistent storage. 
    ...
    FTE_BL_NET_PARAMS       fnet;    /**< @brief FNET TCP/IP stack specific 
                                             * configuration parameters.
                                             */
    FTE_BL_BOOT_PARAMS      boot;    /**< @brief Bootloader specific 
                                             * configuration parameters 
                                             */
    FTE_BL_TFTP_PARAMS      tftp;    /**< @brief TFTP loader specific 
                                             * configuration parameters.  
                                             */
    unsigned long           ulCRC32;
    
} FTE_BL_DYNAMIC_PARAMS;
