...
#if FTE_BL_CFG_HARDWARE_VERSION == FTE_BL_MODEL_1
    #define FTE_BL_CFG_PARAMS_DEVICE_NAME   "FTE-EB1"
#elif FTE_BL_CFG_HARDWARE_VERSION == FTE_BL_MODEL_2
    #define FTE_BL_CFG_PARAMS_DEVICE_NAME   "FTE-EB2"
#elif FTE_BL_CFG_HARDWARE_VERSION == FTE_BL_MODEL_3
    #define FTE_BL_CFG_PARAMS_DEVICE_NAME   "FTE-EB3"
#elif FTE_BL_CFG_HARDWARE_VERSION == FTE_BL_MODEL_4
    #define FTE_BL_CFG_PARAMS_DEVICE_NAME   "FTE-EB4"
#elif FTE_BL_CFG_HARDWARE_VERSION == FTE_BL_MODEL_5
    #define FTE_BL_CFG_PARAMS_DEVICE_NAME   "FTE-EB5"
