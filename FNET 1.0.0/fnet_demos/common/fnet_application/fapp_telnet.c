...
static char fapp_telnet_cmd_line_buffer[FAPP_CFG_SHELL_MAX_LINE_LENGTH];
...
void fapp_telnet_info(fnet_shell_desc_t desc)
{
    ...
    fnet_shell_println(desc, FAPP_SHELL_INFO_FORMAT_S, "TELNET server", telnet_enabled ? FAPP_SHELL_INFO_ENABLED : FAPP_SHELL_INFO_DISABLED);
}
