function fnetPrintHeader(title){
	document.write(' \
		<div id="fnet_banner_wrapper">\
			...
			<a href="http://www.freescale.com" target="_blank">\
			<img src="/fsl_logo.jpg" border="0" alt="Freescale.com"/>\
 			</a>\
			</div>\
			<div id="fnet_banner_center" nowrap>\
				<div id="fnet_banner_topbox" nowrap>\
					<div class="fnet_banner_title" nowrap>FNET\
						<span class="fnet_banner_internal"><a href="http://fnet.sourceforge.net/"> Freescale TCP/IP stack</a></span>\
					</div>\
				</div>\
...
function fnetPrintFooter(){
	document.write(' \
		...
		<br/>\
		<div id="fnet_footer">\
			<center>&copy; 2005-2011 by Andrey Butok, Freescale Semiconductor, Inc. </center>\
		</div>');    
}
function sfHover(){
