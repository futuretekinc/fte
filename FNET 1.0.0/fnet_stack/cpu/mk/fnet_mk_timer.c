...
void fnet_cpu_timer_init( unsigned int period_ms )
{
    ...
    */
    fnet_timer_prev_isr = fnet_isr_set_vector(FNET_CFG_CPU_TIMER_VECTOR_NUMBER, fnet_cpu_timer_handler_top,
...
void fnet_cpu_timer_release( void )
{
     ...
     */
    fnet_isr_reset_vector(FNET_CFG_CPU_TIMER_NUMBER, (void(*)())fnet_timer_prev_isr);
}
