...
#define FNET_TIMER_INT_LEVEL   (FNET_CFG_CPU_TIMER_VECTOR_PRIORITY) /* Timer interrupt level. Ignored for MCF V1 */
    ...
    #undef FNET_TIMER_NUMBER
    #define FNET_TIMER_NUMBER 3
...
volatile static unsigned long fnet_timer_prev_isr = 0; //TBD ???
...
static void fnet_cpu_timer_handler_top( void )
{
     ...
     */
    FNET_MCF_TIMER_DTER(FNET_TIMER_NUMBER) = FNET_MCF_TIMER_DTER_REF; 
#endif    
...
void fnet_cpu_timer_init( unsigned int period_ms )
{
     ...
     */
    fnet_timer_prev_isr = fnet_isr_set_vector(FNET_TIMER_VECTOR_NUMBER, fnet_cpu_timer_handler_top,
    ...
    FNET_MCF_TIMER_DTMR(FNET_TIMER_NUMBER) = FNET_MCF_TIMER_DTMR_CE_NONE;
    FNET_MCF_TIMER_DTRR(FNET_TIMER_NUMBER) = period_ms * FNET_TIMER_CLKIN_PER_MS;
    FNET_MCF_TIMER_DTER(FNET_TIMER_NUMBER) = FNET_MCF_TIMER_DTER_REF | FNET_MCF_TIMER_DTER_CAP;
    FNET_MCF_TIMER_DTCN(FNET_TIMER_NUMBER) = 0;
  
    FNET_MCF_TIMER_DTMR(FNET_TIMER_NUMBER)
        = (FNET_TIMER_TMR_PS_VAL << 8) | FNET_MCF_TIMER_DTMR_RST | FNET_MCF_TIMER_DTMR_CLK_DIV1
              | FNET_MCF_TIMER_DTMR_ORRI | FNET_MCF_TIMER_DTMR_FRR;
#endif
}
...
void fnet_cpu_timer_release( void )
{
    ...
    FNET_MCF_TIMER_DTMR(FNET_TIMER_NUMBER) = FNET_MCF_TIMER_DTMR_CE_NONE; /* Disable timer. */
    FNET_MCF_TIMER_DTER(FNET_TIMER_NUMBER) = FNET_MCF_TIMER_DTER_REF | FNET_MCF_TIMER_DTER_CAP; /* Clear event conditions. */
    
#endif    
    
    /* Uninstall interrupt handler.
     */
    fnet_isr_reset_vector(FNET_TIMER_VECTOR_NUMBER, (void(*)())fnet_timer_prev_isr);
