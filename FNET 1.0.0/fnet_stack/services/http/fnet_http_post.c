...
/* Prototypes */
int fnet_http_post_handle(struct fnet_http_if * http, struct fnet_http_uri * uri);
int fnet_http_post_receive(struct fnet_http_if * http);
int fnet_http_post_send(struct fnet_http_if * http);
void fnet_http_post_close(struct fnet_http_if * http);
...
static int fnet_http_post_receive(struct fnet_http_if * http)
{
    ...
    if(http->send_ptr)
    {
        post_ptr = (const struct fnet_http_post *) http->send_ptr;
...
{
    int result = FNET_ERR;
    const struct fnet_http_post *post_ptr = (const struct fnet_http_post *) http->send_ptr;
