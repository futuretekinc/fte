...
/* Prototypes */
int fnet_http_get_handle(struct fnet_http_if * http, struct fnet_http_uri * uri);
int fnet_http_get_send(struct fnet_http_if * http);
void fnet_http_get_close(struct fnet_http_if * http);
