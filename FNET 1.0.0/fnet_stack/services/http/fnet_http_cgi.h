...
/*con cls reference to a pointer, initially set to NULL, that this callback can set to
some address and that will be preserved by MHD for future calls for this
request;
since the access handler may be called many times (i.e., for a PUT/POST
operation with plenty of upload data) this allows the application to easily
associate some request-specific state;*/

/*You can use cookie to associate custom information
with a connection instance. If you store context information in the cookie, your
callback functions can retrieve the cookie and determine the context.*/
