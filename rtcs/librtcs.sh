...
cp -f "${MQXROOTDIR}/rtcs/source/include/httpsrv.h" "${OUTPUTDIR}/httpsrv.h"
cp -f "${MQXROOTDIR}/rtcs/source/include/httpsrv_prv.h" "${OUTPUTDIR}/httpsrv_prv.h"
cp -f "${MQXROOTDIR}/rtcs/source/include/httpsrv_supp.h" "${OUTPUTDIR}/httpsrv_supp.h"
...
cp -f "${MQXROOTDIR}/rtcs/source/include/rtcs_base64.h" "${OUTPUTDIR}/rtcs_base64.h"
cp -f "${MQXROOTDIR}/rtcs/source/include/rtcs_in.h" "${OUTPUTDIR}/rtcs_in.h"
cp -f "${MQXROOTDIR}/rtcs/source/include/rtcs_smtp.h" "${OUTPUTDIR}/rtcs_smtp.h"
